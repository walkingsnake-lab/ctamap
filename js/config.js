...
const BACKWARD_CONFIRM_POLLS = 8;            // consecutive polls required before accepting any backward move — high bar, prefer appearing ahead over behind
const FORWARD_CONFIRM_POLLS  = 3;            // consecutive polls required before accepting a suspiciously fast forward jump (prediction→realtime artifact)
